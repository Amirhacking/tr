...
if (matches == 'amir'  or matches == 'امیر') and is_sudo(msg)  then
...
sendText(msg.chat_id, msg.id,'آره آنلاینم مگه (امیر) میزاره آفلاین بشم '..check_markdown(CompanyName)..' جون 😍', 'html')
end
GetUser(msg.sender_user_id,GetName)
end
